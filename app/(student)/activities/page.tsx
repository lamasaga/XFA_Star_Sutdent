  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">记录你的课内外活动与成长足迹</p>
      </div>
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground">还没有活动记录，快去参加学校活动吧！</p>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge variant="outline" className={`text-xs ${CATEGORY_COLORS[a.category] || ""}`}>
